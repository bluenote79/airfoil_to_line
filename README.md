...
Also you can decide to generate new points by cubic iteration. Here the tool uses [**pyfoil**](https://github.com/airgproducts/pyfoil) by [hiaselhans](https://github.com/airgproducts/pyfoil/commits?author=hiaselhans)
